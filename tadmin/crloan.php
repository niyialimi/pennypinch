          ...
          <div class="col-md-12">
            <div class="card">
              <div class="card-header">
                <h5 class="title">Create New Loan</h5>
              </div>
              <div class="card-body">
                 <form action="" class="crloanform" id="createloan-form"  enctype="multipart/form-data" method="post" role="form" data-toggle="validator">			
                    <div class="row">
                    ...
                    <div class="col-md-5 px-1">
                      <div class="form-group">
                       <label>Name</label>
                        <input type="text" class="form-control" placeholder="Name Loan is Identified by e.g Long Term Loan" name="loanname" id="loanname" required>
                      </div>
                    </div>
                    <div class="col-md-3 pl-1">
                      <div class="form-group">
                        <label>Interest</label>
                        <input type="text" class="form-control" placeholder="Interest on Loan e.g 10" name="interest" id="interest" required>
                      </div>
                    </div>   
                    <div class="col-md-2 pl-1">
                      <div class="form-group">
                        <label>Duration</label>
                        <input type="text" class="form-control" placeholder="Duration in which Loan is to be paid e.g 10" name="duration" id="duration" required>
                      </div>
                    </div>                 
                  </div>
                  <div id="message"></div>
                 <div align="center">
                      <div class="form-group">
                        <button type="submit" class="btn btn-primary btn-sm" id="crtloanbut">Create New Loan</button>
                      </div>
                    </div>
               </form>     
              </div>
