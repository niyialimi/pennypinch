...
<head>
  ...
  <title>
   	PennyPinch:: Loan Application Log
  </title>
...
<body class="">
          ...
          <div class="col-md-12">
            <div class="card">
              ...
              <div class="table-responsive">
                <table width="500" id="tabl" class="table table-striped table-bordered">
  ...
  <td>Coop Number</td>
   ...
   <?php
    $month=date('F');
   $sn=0;
   $newquery="select memstab.mem_surname,memstab.mem_fname,memstab.mem_coopno,loantab.loanstatus,loantab.mem_id,loantab.amount,loantab.loan_month,loantab.loan_type from memstab inner join loantab on memstab.mem_id=loantab.mem_id" ;
  ...
  ?>
  <tr>
  <td><?php echo $rows['mem_coopno']; ?></td>
    <td height="58"><?php echo $_SESSION['surname']." ".$_SESSION['firstname']; ?></td>
    	<td><?php
		if($_SESSION['loanstatus']==0)
		{
			echo "Not Granted";
		}else echo "Granted";
		?>
        <input type="hidden" name="memid" value="<?php echo $_SESSION['mem_id']; ?>" />
            <input type="hidden" name="rowcount" value="<?php echo $numrow; ?>" />
         </td>
        
		<td><?php echo $_SESSION['loantype']; ?></td>
    <td><?php echo $_SESSION['amount']; ?>
    <input type="hidden" name="amountapp" value="<?php echo $_SESSION['amount'];?>" /></td>
  
   <td><?php echo $_SESSION['loanmonth']; ?>
    <input type="hidden" name="amountapp" value="<?php echo $_SESSION['amount'];?>" /></td>
  </tr>
   <?php
	  }
...
<script>
        ...
        buttons: [
           // 'copyHtml5',
			...
			{
				extend: 'csvHtml5' ,
				title: 'List Of Members Who Applied For Loan Facility'
			},       
			{
				extend: 'excelHtml5' ,
				title: 'List Of Members Who Applied For Loan Facility'
